...
Uses the "jQuery MiniColors":http://labs.abeautifulsite.net/jquery-minicolors/ plugin by "A Beautiful Site":http://www.abeautifulsite.net/ for the colour picker, while using -"liveplugins":http://pwwang.com/2012/06/19/jquery-liveplugins-get-your-jquery-plugins-work-on-future-elements/- the built in entwine to successfully bind the MiniColors plugin to the necessary elements.
